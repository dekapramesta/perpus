...
class MemberModel extends CI_Model{
    ...
    {
        $this->db->select('member.id_member, member.kode_member, member.nama_member, member.email_member, member.alamat_member, member.foto_member, member.no_telp_member');
        $this->db->from('member');
