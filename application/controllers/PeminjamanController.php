...
class PeminjamanController extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['tglpinjam']  = date('Y-m-d'); //Menampilkan data tanggal sesuai hari ini
        $data['tglkembali'] = date('Y-m-d', strtotime('+7 day', strtotime($data['tglpinjam']))); //Menampilkan data tanggal +7 setelah hari ini
