...

{
    ...
    // Add data pada Bagian Ebook
    public function add_view_ebook()

    {
        ...
        $this->load->view('Admin/Buku/AddE-Book');
    ...
    public function add_view_jurnal()

    {
        ...
        $this->load->view('Admin/Buku/AddJurnal');
...

    {
        ...
        if ($jenis_buku->jenis_buku == "E-Book") { //seleksi view detail buku (jenis buku : E-Book)
            $this->load->view('Admin/Template/Header', $data_header);
            $this->load->view('Admin/Buku/DetailEbook', $data);
            $this->load->view('Admin/Template/Footer');
        } elseif ($jenis_buku->jenis_buku == "Buku") { //seleksi view detail buku (jenis buku : Buku)
            $this->load->view('Admin/Template/Header', $data_header);
            ...
            $this->load->view('Admin/Template/Footer');
        } elseif ($jenis_buku->jenis_buku == "Jurnal") { //seleksi view detail buku (jenis buku : Jurnal)
            $this->load->view('Admin/Template/Header', $data_header);
            $this->load->view('Admin/Buku/DetailJurnal', $data);
            $this->load->view('Admin/Template/Footer');
        } else {
...

    {
        ...
        if ($jenis_buku->jenis_buku == "E-Book") { //seleksi view detail buku (jenis buku : E-Book)
            ...
            $this->load->view('Admin/Template/Header', $data_header);
            $this->load->view('Admin/Buku/EditJurnal', $data);
            $this->load->view('Admin/Template/Footer');
        } else {
            #output gak keluar
            echo "Pilihan Tidak Ada";
